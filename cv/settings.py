...
DATABASES = {
    'default': {
        ...
        'NAME': 'doumy_pro_cv',       # Nom de la base de données
        'USER': 'kouakou',                    # Nom d'utilisateur MySQL
        'PASSWORD': 'myBD2024',               # Mot de passe MySQL
...
LOGOUT_REDIRECT_URL = '/login/'  # Ou toute autre page
...
EMAIL_HOST_USER = 'kouakouclaudedoumy@gmail.com'  # Adresse e-mail de l'expéditeur
EMAIL_HOST_PASSWORD = 'trsk zbap kmvy uoxy'  # Mot de passe de votre adresse e-mail ou App Password